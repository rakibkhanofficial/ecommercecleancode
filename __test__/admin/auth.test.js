...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'David_Goyette',
      password: 'N3DnfVbcE0BCBm3',
      email: 'Ara_Lebsack76@yahoo.com',
      name: 'Joy Marquardt III',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Connecticut',
      ...
      userType: 694,
      mobileNo: '(791) 817-5263',
      resetPasswordLink: {},
      loginRetryLimit: 605,
      loginReactiveTime: '2024-03-22T21:31:54.167Z',
      id: '65be45e9748bd9172c111f73'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Wilbert_Wolff94',
        'password':'wZtZ79d5WYrp8Nj',
        'email':'Virginie.Wehner@yahoo.com',
        'name':'Ana Goyette',
        'shippingAddress':[{
          '_id':false,
          'pincode':'redundant',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Virginie.Wehner@yahoo.com', });
