...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Judah.Breitenberg',
      password: 'SxjO82qjZ5BQPPw',
      email: 'Lauryn.Dicki@yahoo.com',
      name: 'Eduardo Schroeder',
      shippingAddress: [
        {
          _id: false,
          pincode: 'transmitting',
          address1: 'Concrete',
          address2: 'Oklahoma',
          landmark: 'Handmade',
          city: 'Account',
      ...
      userType: 662,
      mobileNo: '(020) 522-8904',
      resetPasswordLink: {},
      loginRetryLimit: 369,
      loginReactiveTime: '2024-05-10T14:18:36.269Z',
      id: '65be45ea748bd9172c11204b'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Aida_Kuhlman',
        'password':'DVYDyjSTdB_D9XR',
        'email':'Juvenal.Gutkowski79@hotmail.com',
        'name':'Jesus Trantow',
        'shippingAddress':[{
          '_id':false,
        ...
        'wishlist':[{
          '_id':false,
          'productId':'Switchable'
        }],
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(513) 749-5203',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Juvenal.Gutkowski79@hotmail.com', });
