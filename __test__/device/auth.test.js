...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Callie_Thompson96',
      password: '717_i8YX4NEjrXO',
      email: 'Andres80@hotmail.com',
      name: 'Gordon Upton',
      shippingAddress: [
        {
          _id: false,
          ...
          isDefault: true,
          state: 'Guadeloupe',
          addressType: 'Grass-roots',
          fullName: 'non-volatile',
          mobile: 872,
          addressNo: 993
        }
      ],
      ...
      userType: 605,
      mobileNo: '(665) 543-5822',
      resetPasswordLink: {},
      loginRetryLimit: 181,
      loginReactiveTime: '2024-05-07T07:12:28.922Z',
      id: '65be45ea748bd9172c111fdf'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Amely_Morissette83',
        'password':'urUNXFLB9ZsySWp',
        'email':'Brady_Pouros@gmail.com',
        'name':'Rick O\'Hara MD',
        'shippingAddress':[{
          '_id':false,
          'pincode':'deliver',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Brady_Pouros@gmail.com', });
